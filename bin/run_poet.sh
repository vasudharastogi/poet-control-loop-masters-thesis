#!/bin/bash
#SBATCH --job-name=p1_0035_300
#SBATCH --output=p1_0035_300_%j.out
#SBATCH --error=p1_0035_300_%j.err
...
mpirun -n 144 ./poet --interp dolo_fgcs_3_rt.R dolo_fgcs_3.qs2 p1_0035_300
