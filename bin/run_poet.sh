#!/bin/bash
#SBATCH --job-name=m_p1_200_3_0
#SBATCH --output=m_p1_200_3_0_%j.out
#SBATCH --error=m_p1_200_3_0_%j.err
...
mpirun -n 144 ./poet --interp dolo_fgcs_3_rt.R dolo_fgcs_3.qs2 m_p1_200_3_0
